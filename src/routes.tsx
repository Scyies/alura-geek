      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<Header />}>
            ...
            <Route path="/admin/new-product" element={<ProtectedRoute><AdicionarNovoProduto /></ProtectedRoute>} />
            <Route path="/admin/edit-product/:id" element={<ProtectedRoute><AdicionarNovoProduto /></ProtectedRoute>} />
